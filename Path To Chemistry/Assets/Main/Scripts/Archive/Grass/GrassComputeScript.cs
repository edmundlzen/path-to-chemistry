...
public class GrassComputeScript : MonoBehaviour
{
    ...
    // Blade
    [Header("Blade")] public float grassHeight = 1;
    ...
    [SerializeField] private ShaderInteractor interactor;

    // Wind
    [Header("Wind")] public float windSpeed = 10;

    public float windStrength = 0.05f;

    // Interactor
    [Header("Interactor")] public float affectRadius = 0.3f;

    public float affectStrength = 5;

    // LOD
    [Header("LOD")] public float minFadeDistance = 40;

    public float maxFadeDistance = 60;

    // Material
    [Header("Material")] public Color topTint = new Color(1, 1, 1);
    ...
    // Other
    [Header("Other")] public ShadowCastingMode castShadow;
    ...
    private void LateUpdate()
    {
        ...
        var bounds = TransformBounds(m_LocalBounds);
    ...
    private void OnEnable()
    {
        ...
        if (grassPainter == null || sourceMesh == null || computeShader == null || material == null) return;
        sourceMesh = GetComponent<MeshFilter>().sharedMesh;
        ...
        var numSourceVertices = vertices.Length;

        // Each segment has two points
        var maxBladesPerVertex = Mathf.Max(1, m_AllowedBladesPerVertex);
        var maxSegmentsPerBlade = Mathf.Max(1, m_AllowedSegmentsPerBlade);
        ...
        m_InstantiatedComputeShader.GetKernelThreadGroupSizes(m_IdGrassKernel,
            out var threadGroupSize, out _, out _);
    ...
    public void UpdateGrass()
    {
        ...
        Graphics.DrawProceduralIndirect(m_InstantiatedMaterial, bounds, MeshTopology.Triangles, m_ArgsBuffer, 0, null,
            null, castShadow, true, gameObject.layer);
    }
