...
void CTI_AnimateVertex(inout CTIVertexInput v, float4 animParams, float3 baseWindMultipliers)
{
    ...
    //SHADERGRAPH_OBJECT_POSITION; //float3(UNITY_MATRIX_M[0].w, UNITY_MATRIX_M[1].w, UNITY_MATRIX_M[2].w);
    ...
    v.positionOS.xyz += ((vWavesSum.xyx * bend) + (xWind.xyz * vWavesSum.y * animParams.w)) * xWind.w *
        _CTI_SRP_Turbulence;
