...
*/
    ...
    private void Update()
    {
        ...
        if (Physics.Raycast(ray, out hit, 2))
        {
            ...
            {
                GameObject.Find("Slider").GetComponent<Slider>().maxValue =
                    Convert.ToInt32(playerData.slotItem[$"Slot{hotbar.slotNum}"]["Quantity"]);
            }
            else if (Input.GetMouseButtonDown(0) && player.raycastObject == "Add2")
            {
                ...
                {
                    if (playerData.Molecule.ContainsKey(playerData.slotItem[$"Slot{hotbar.slotNum}"]["Element"]
                        .ToString()))
                        playerData.Molecule[playerData.slotItem[$"Slot{hotbar.slotNum}"]["Element"].ToString()] =
                            Convert.ToInt32(
                                playerData.Molecule[
                                    playerData.slotItem[$"Slot{hotbar.slotNum}"]["Element"].ToString()]) + 1;
                    else
                    ...
                    if (Convert.ToInt32(playerData.slotItem[$"Slot{hotbar.slotNum}"]["Quantity"]) > 1)
                    {
                        playerData.slotItem[$"Slot{hotbar.slotNum}"]["Quantity"] =
                            Convert.ToInt32(playerData.slotItem[$"Slot{hotbar.slotNum}"]["Quantity"]) - 1;
                    }
                    else
                    {
            ...
            else if (Input.GetMouseButtonDown(0) && player.raycastObject == "React" && GameObject.Find("Flask") != null)
            {
                ...
                if (playerData.levelAvailable.Contains("Level 1"))
                    if (playerData.flaskElements.ContainsKey("K") && playerData.flaskElements.ContainsKey("Water") &&
                        playerData.flaskElements.Count == 2)
                    {
                ...
                if (playerData.levelAvailable.Contains("Level 2"))
                    if (playerData.flaskElements.ContainsKey("Hydrochloric Acid") &&
                        playerData.flaskElements.ContainsKey("Ammonia") && playerData.flaskElements.Count == 2)
                    {
                ...
                if (playerData.levelAvailable.Contains("Level 3"))
                    if (playerData.flaskElements.ContainsKey("Hydrogen Peroxide") &&
                        playerData.flaskElements.ContainsKey("Sodium Iodide") && playerData.flaskElements.Count == 2)
                    {
                ...
                if (playerData.levelAvailable.Contains("Level 4"))
                    if (playerData.flaskElements.ContainsKey("Sodium Acetate") &&
                        playerData.flaskElements.ContainsKey("Water") && playerData.flaskElements.Count == 2)
                    {
                ...
                {
                    if (playerData.flaskElements.ContainsKey("Potassium Iodide") &&
                        playerData.flaskElements.ContainsKey("Hydrogen Peroxide") &&
                        playerData.flaskElements.ContainsKey("Soup") && playerData.flaskElements.Count == 3)
                    {
