...
public class Hotbar : MonoBehaviour
{
    ...
    private void flaskButton(int Index)
    {
        var playerData = PlayerData.Instance();
        if (playerData.flaskElements.Count >= Index)
        {
            for (var i = 1; i <= 9; i = i + 1)
                if (Convert.ToString(playerData.slotItem[$"Slot{i}"]["Element"]) ==
                    playerData.flaskElements.Keys.ElementAt(Index - 1))
                {
            ...
            if (playerData.flaskElements.Values.ElementAt(Index - 1) > 1)
                playerData.flaskElements[playerData.flaskElements.Keys.ElementAt(Index - 1)] =
                    Convert.ToInt32(playerData.flaskElements[playerData.flaskElements.Keys.ElementAt(Index - 1)]
                        .ToString()) - 1;
            else
    ...
    private void craftButton(int Index)
    {
        var playerData = PlayerData.Instance();
        if (playerData.Molecule.Count >= Index)
        {
            for (var i = 1; i <= 9; i = i + 1)
                if (Convert.ToString(playerData.slotItem[$"Slot{i}"]["Element"]) ==
                    playerData.Molecule.Keys.ElementAt(Index - 1))
                {
                    playerData.slotItem[$"Slot{i}"]["Quantity"] =
                        Convert.ToInt32(playerData.slotItem[$"Slot{i}"]["Quantity"]) + 1;
                    break;
            ...
            if (playerData.Molecule.Values.ElementAt(Index - 1) > 1)
                playerData.Molecule[playerData.Molecule.Keys.ElementAt(Index - 1)] =
                    Convert.ToInt32(playerData.Molecule[playerData.Molecule.Keys.ElementAt(Index - 1)].ToString()) - 1;
            else
