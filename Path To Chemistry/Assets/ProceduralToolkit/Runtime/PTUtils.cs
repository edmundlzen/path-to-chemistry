...
namespace ProceduralToolkit
{
    ...
    public static class PTUtils
    {
        ...
        /// <param name="set">
        ///     Set of items where key <typeparamref name="T" /> is item identificator and value is item weight
        /// </param>
        ...
        ///     Tends to overload knapsack: fills remainder with one smallest item.
        /// </returns>
        /// <remarks>
            ...
            Dictionary<T, int> knapsack = null)
        {
            ...
            if (knapsack == null)
            {
                ...
                foreach (var key in keys) knapsack[key] = 0;
            }
            ...
            if (remainder > 0)
            {
                ...
                for (var i = 0; i < keys.Count; i++)
                {
                    ...
                    if (knapsack[key] != 0)
                    {
                        ...
                        if (key.Equals(smallestKey)) return knapsack;
                        knapsack[key]--;
                        remainder += set[key];
                        startIndex = i + 1;
                        break;
