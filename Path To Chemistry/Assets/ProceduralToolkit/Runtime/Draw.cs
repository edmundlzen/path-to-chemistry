...
namespace ProceduralToolkit
{
    ...
    public static partial class Draw
    {
        ...
        ///     Draws a segment
        /// </summary>
        public static void Segment2(DebugDrawLine drawLine, Segment2 segment, Color color, float duration,
            bool depthTest)
        {
        ...
        ///     Draws a segment
        /// </summary>
        public static void Segment3(DebugDrawLine drawLine, Segment3 segment, Color color, float duration,
            bool depthTest)
        {
            drawLine(segment.a, segment.b, color, duration, depthTest);
        }
        ...
        {
            var right = rotation * planeRight * scale.x;
            var forward = rotation * planeForward * scale.y;
            var forwardRight = position + right * 0.5f + forward * 0.5f;
            var backRight = forwardRight - forward;
            var backLeft = backRight - right;
            var forwardLeft = forwardRight - right;
            ...
            Vector3 scale)
        {
            ...
            var up = rotation * Vector3.up * scale.y;
            var forward = rotation * Vector3.forward * scale.z;

            var a1 = position + right * 0.5f + up * 0.5f + forward * 0.5f;
            var b1 = a1 - up;
            var c1 = b1 - right;
            var d1 = a1 - right;
        ...
        public static void WireArc(Func<float, float, Vector3> pointOnCircle, Action<Vector3, Vector3> drawLine,
            ...
            float fromAngle, float toAngle)
        {
            GetSegmentsAndSegmentAngle(fromAngle, toAngle, out var segments, out var segmentAngle);
            ...
            float fromAngle, int segments, float segmentAngle)
        {
            ...
            {
                var a = position + pointOnCircle(radius, currentAngle);
                currentAngle += segmentAngle;
                var b = position + pointOnCircle(radius, currentAngle);
                drawLine(a, b);
            }
        }
            ...
            Quaternion rotation, float radius, float fromAngle, int segments, float segmentAngle)
        {
            ...
            for (var i = 0; i < segments; i++)
            {
                var a = position + rotation * pointOnCircle(radius, currentAngle);
                currentAngle += segmentAngle;
                var b = position + rotation * pointOnCircle(radius, currentAngle);
                drawLine(a, b);
            }
        }
        ...
        public static void WireCone(Action<Vector3, Vector3> drawLine, Vector3 position, Quaternion rotation,
            ...
            float length)
        {
            var baseCenter = position + rotation * Vector3.up * length;
            var baseRadius = Mathf.Tan(angle * Mathf.Deg2Rad) * length + apexRadius;
            WireCircleXZ(drawLine, baseCenter, rotation, baseRadius);

            var a2 = baseCenter + rotation * Geometry.PointOnCircle3XZ(baseRadius, 0);
            var b2 = baseCenter + rotation * Geometry.PointOnCircle3XZ(baseRadius, 90);
            var c2 = baseCenter + rotation * Geometry.PointOnCircle3XZ(baseRadius, 180);
            var d2 = baseCenter + rotation * Geometry.PointOnCircle3XZ(baseRadius, 270);
            ...
            else
            {
                ...
                var a1 = position + rotation * Geometry.PointOnCircle3XZ(apexRadius, 0);
                var b1 = position + rotation * Geometry.PointOnCircle3XZ(apexRadius, 90);
                var c1 = position + rotation * Geometry.PointOnCircle3XZ(apexRadius, 180);
                var d1 = position + rotation * Geometry.PointOnCircle3XZ(apexRadius, 270);
        ...
        public static void WireCone(DebugDrawLine drawLine, Vector3 position, Quaternion rotation, float apexRadius,
            ...
            Color color, float duration, bool depthTest)
        {
            var upperCenter = position + rotation * Vector3.up * length;
            var upperRadius = Mathf.Tan(angle * Mathf.Deg2Rad) * length + apexRadius;
            WireCircleXZ(drawLine, upperCenter, rotation, upperRadius, color, duration, depthTest);

            var a2 = upperCenter + rotation * Geometry.PointOnCircle3XZ(upperRadius, 0);
            var b2 = upperCenter + rotation * Geometry.PointOnCircle3XZ(upperRadius, 90);
            var c2 = upperCenter + rotation * Geometry.PointOnCircle3XZ(upperRadius, 180);
            var d2 = upperCenter + rotation * Geometry.PointOnCircle3XZ(upperRadius, 270);
